### Hi there 👋
# I'm Dawood Arif — Full-Stack Developer
📍 Gujrat, Pakistan

## What I Do

- Build full eCommerce systems (catalogs, carts, checkout, admin dashboards)
- Integrate payment gateways (secure checkout flows, order verification, webhooks)
- Design authentication systems (JWT, sessions, role-based access control)
- Develop webhook-driven backend workflows (orders, payments, external sync)
- Create CMS-powered websites (Strapi / headless content architecture)
- Build API-first applications (REST + GraphQL services)
...
<img src="https://cdn.simpleicons.org/strapi" width="45"/>
  <img src="https://cdn.simpleicons.org/contentful" width="45"/>
</p>
